...
def make_placeholder(msg):
    return (
        ...
        f"background:#ffffff;border-radius:10px;color:#999;font-family:monospace;font-size:14px'>"
        f"<div style='text-align:center'>"
        f"<div style='font-size:48px;margin-bottom:12px'>&#x1F9EC;</div>"
        f"<div style='color:#666'>{msg}</div>"
        f"</div></div>"
    )
...
PLACEHOLDER = (
    ...
    "background:#ffffff;border-radius:10px;color:#999;font-family:monospace;font-size:14px'>"
    "<div style='text-align:center'>"
    "<div style='font-size:48px;margin-bottom:12px'>&#x1F9EC;</div>"
    "<div style='color:#666'>Upload an H&amp;E tile and click<br>"
    "<b style='color:#4169E1'>Run GigaTIME Inference</b></div>"
    "</div></div>"
)
